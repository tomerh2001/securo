...
describe('connection recovery', () => {
  ...
  it.each(['ok', 'auth_required'] as const)('imports only after a requested collection succeeds (%s)', async result => {
    ...
    data.source.status = result; data.source.lastSuccessAt = new Date().toISOString()
  ...
  it('explains offline phone recovery and restricts mutation actions to editors', async () => {
    ...
    expect(screen.getByText(/To avoid repeated sign-in attempts/)).toBeInTheDocument()
  })
